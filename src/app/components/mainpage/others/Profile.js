...
export default function Profile(props) {
  ...
  const boxShadowProp = {
    enabled: "0px 5px 5px 0px rgba(0,0,0,0.5)",
    disabled: "0px 0px 0px 0px rgba(0,0,0,0)",
  };
  ...
  const avatarStyle = {
    ...
    position: "relative",
    bottom: "5.2rem",
    boxShadow: boxShadowProp.enabled,
  };
  ...
  return (
    <Box
      sx={{
        opacity: amISelected ? 0.3 : 1,
        boxShadow: amISelected ? boxShadowProp.disabled : boxShadowProp.enabled,
      }}
